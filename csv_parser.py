...
def gen_total_max_weighted_score_per_topic(parsed_csv_with_max_weighted_score):
    # sum of max weighted score for each topic
    transform = copy.deepcopy(parsed_csv_with_max_weighted_score)
    unique_topics = get_unique("Topic", transform)
...
def gen_maturity(parsed_csv_with_total_max):
...
def gen_avg_maturity(parsed_csv_with_maturity):
